...
void
EquipmentInfo::setAttackType(std::string attackType)
{
    if (attackType == "swing")
    {
...
void
EquipmentInfo::addSound (EquipmentSoundEvent event, std::string filename)
{
...
std::string
EquipmentInfo::getSound (EquipmentSoundEvent event) const
{
